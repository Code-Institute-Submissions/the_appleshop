...
class TestProductsViews(TestCase):
    ...
    def test_get_user_purchases(self):
        ...
        self.assertEqual(get_user_purchases(new_user), ['testproduct1','testproduct2','testproduct3'])
    ...
    def test_product_detail_view(self):
        ...
        order_line_item1= OrderLineItem(user=new_user, order=order,
                                               ...
                                               quantity=1)
        order_line_item1.save()
        response=self.client.get('/products/1', content_type="html/text", follow=True)
